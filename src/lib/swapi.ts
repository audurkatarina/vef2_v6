...
import { ICharactersAnswerGQL } from '../types';
...
// TODO EKKI any hér!
export async function fetchCharacters(after = ''): Promise<ICharactersAnswerGQL> {
  ...
  return fetchSwapi<ICharactersAnswerGQL>(query, { after });
}
